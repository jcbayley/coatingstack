...
class PO(object):
    ...
    def __init__(self, state_dim, num_discrete, num_cont, hidden_size, lr=1e-4, lower_bound=0.1, upper_bound=1.0, n_updates=1):
    ...
    def select_action(self, state):
        ...
        return action, actiond, actionc, log_prob, d_probs, c_means, c_std
